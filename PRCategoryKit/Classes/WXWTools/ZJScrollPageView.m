...
- (ZJScrollSegmentView *)segmentView {
    if (!_segmentView) {
        ...
        ZJScrollSegmentView *segment = [[ZJScrollSegmentView alloc] initWithFrame:CGRectMake(self.segmentStyle.offsetX, 0, self.bounds.size.width-self.segmentStyle.offsetX, self.segmentStyle.segmentHeight) segmentStyle:self.segmentStyle delegate:self.delegate titles:self.titlesArray titleDidClick:^(ZJTitleView *titleView, NSInteger index) {
